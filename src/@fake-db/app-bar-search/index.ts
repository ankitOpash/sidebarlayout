...
const searchData: AppBarSearchType[] = [
  ...
  {
    id: 12,
    url: '/apps/user/view/summary',
    icon: 'tabler:user',
    title: 'User View - Summary',
    category: 'appsPages'
  },
  {
    id: 13,
    url: '/apps/user/view/facets',
    icon: 'tabler:lock',
    title: 'User View - FACETS',
    category: 'appsPages'
  },
  {
    id: 14,
    url: '/apps/user/view/teams',
    icon: 'tabler:currency-dollar',
    title: 'User View - Teams',
    category: 'appsPages'
  },
  {
    id: 15,
    url: '/apps/user/view/settings',
    icon: 'tabler:bell',
    title: 'User View - Settings',
    category: 'appsPages'
  },
  {
    id: 17,
